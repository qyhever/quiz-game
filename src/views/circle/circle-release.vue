<template>
  <div>
    ...
    <div class="release_content">
      ...
      <!-- 上传文件 -->
      <van-uploader v-model="fileList" multiple :max-count="9" :deletable="false" :before-read="beforeRead" :after-read="afterRead"
      ...
      <!-- <div class="release_emoji">
        ...
        <div class="wyl">
          <cube-scroll>
            <weibo-emoji v-if="isShow" class="emoji_content" :weiboIcon="weiboIcon" @changeEmoji="changeEmoji" ref="emoji"></weibo-emoji>
          </cube-scroll>
        </div>
      </div> -->
    </div>
